...
<head>
    <meta charset="UTF-8">
    <title>Laporan Harian Bank Sampah</title>
    <style>
        /* Reset & Base */
...
<body>
    ...
    <div class="judul-section">
        <h2>Laporan Harian Kegiatan Bank Sampah</h2>
        <p>Tanggal : {{ $tanggalFormat }}</p>
    ...
    @else
        <p class="no-data">Tidak ada transaksi tabungan hari ini</p>
    @endif
    ...
    <table>
        ...
        <tfoot>
            <tr>
                <td colspan="5" class="text-right">TOTAL HARIAN</td>
    ...
    @else
        <p class="no-data">Tidak ada penarikan hari ini</p>
    @endif
    ...
    <div class="ttd-section">
        <table class="ttd-table">
            <tr>
                ...
                <td>
                    <!-- Kolom Kanan -->
                    <div class="ttd-title">Subang, {{ $tanggalFormat }}</div>
